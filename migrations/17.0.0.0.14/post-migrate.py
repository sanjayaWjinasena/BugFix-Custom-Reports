...
def migrate(cr, version):
    ...
    data = [
        ('x_custom_reports', 'x_studio_kanban_state', 'normal', 'In Progress', 10),
        ('x_custom_reports', 'x_studio_kanban_state', 'done', 'Ready', 1),
        ('x_custom_reports', 'x_studio_kanban_state', 'blocked', 'Blocked', 2),
    ]
